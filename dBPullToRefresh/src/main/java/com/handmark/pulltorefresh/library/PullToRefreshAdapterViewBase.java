...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private ListViewTracker mListViewTracker;

	public PullToRefreshAdapterViewBase(Context context) {
		super(context);
		mListViewTracker = new ListViewTracker(mRefreshableView);
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		int incrementalOffset = mListViewTracker.calculateIncrementalOffset(firstVisibleItem, visibleItemCount);
		if(mOnDirectionScrollListener!=null){
			mOnDirectionScrollListener.onScroll(incrementalOffset);
		}
	...
	public final void setOnDirectionScrollListener(OnDirectionScrollListener listener) {
		mOnDirectionScrollListener = listener;
	}
